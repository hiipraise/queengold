...
const globalWithMongoose = global as typeof globalThis & { _mongooseCache?: MongooseCache };
const cached: MongooseCache = globalWithMongoose._mongooseCache ?? { conn: null, promise: null };
if (!globalWithMongoose._mongooseCache) globalWithMongoose._mongooseCache = cached;
