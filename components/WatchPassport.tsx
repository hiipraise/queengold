...
export default function WatchPassport({ passport, onReset }: Props) {
  const isRegistered =
    passport.status === "registered" || passport.status === "sold";
    ...
    <article aria-label="Digital Watch Passport" className="w-full">
      ...
      <div className="passport-card overflow-hidden animate-fade-up delay-100">
        <div
          ...
          style={{
            background: "linear-gradient(160deg, #4B0E23 0%, #2D0614 100%)",
          }}
        >
          <div
          ...
          <p
            className="mt-4 font-display text-xs tracking-[0.35em] uppercase"
        ...
        <div className="px-8 py-8 space-y-0">
          ...
          {passport.firstScannedAt && (
            <div
              ...
              style={{
                background: "rgba(75,14,35,0.07)",
                border: "1px solid rgba(75,14,35,0.12)",
              }}
            >
              <p
              ...
              {passport.scanCount > 1 && (
                <p
                  ...
                  style={{ color: "#5C1A3A", opacity: 0.8 }}
                >
                  Verified {passport.scanCount} time
                  {passport.scanCount !== 1 ? "s" : ""}
                </p>
              )}
            </div>
          )}
          ...
          <div className="pt-8 pb-2 text-center">
            ...
            <p
              ...
              style={{ color: "#8B6C5C", opacity: 0.5 }}
            >
              www.queengold.com
            </p>
          </div>
